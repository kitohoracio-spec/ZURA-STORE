    ...
    <div style={{...ROOT, paddingBottom:64}}>
      ...
      <nav style={{ position:"sticky", top:0, zIndex:100, background:"var(--bg-root)", opacity:0.97, backdropFilter:"blur(12px)", borderBottom:"1px solid var(--border)", padding:"10px 4% 12px", display:"flex", flexDirection:"column", gap:10, transform:navVisible?"translateY(0)":"translateY(-100%)", transition:"transform 0.25s ease" }}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
          <span onClick={()=>goPage("home")} style={{ display:"flex", alignItems:"center", gap:10, cursor:"pointer" }}>
            <span style={{ width:34, height:34, borderRadius:"50%", border:`1.5px solid ${A}`, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"Georgia,serif", fontSize:"1.05rem", color:A, flexShrink:0 }}>Z</span>
          ...
          {searchOpen ? (
            ...
            <button onClick={()=>{ setContaTabInicial("pedidos"); goPage(user?"conta":"auth"); }} style={{ background:"none", border:"none", cursor:"pointer", padding:6, position:"relative", display:"flex" }}>
              <svg width="25" height="25" viewBox="0 0 24 24" fill="none" stroke={(page==="conta"||page==="auth"||page==="admin")?A:"var(--text-dim)"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer style={{ borderTop:"1px solid var(--border)",padding:"48px 5% 24px",display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:40 }}>
        <div>
          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:14 }}>
            <span style={{ width:28, height:28, borderRadius:"50%", border:`1.5px solid ${A}`, display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"Georgia,serif", fontSize:"0.85rem", color:A, flexShrink:0 }}>Z</span>
            <span style={{ fontFamily:"Georgia,serif",fontSize:"1.4rem",color:A,letterSpacing:2 }}>ZURA</span>
          </div>
