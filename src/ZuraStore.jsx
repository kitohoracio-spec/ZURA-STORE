...
const A = "#c8a96e";
const ROOT = { fontFamily:"'Segoe UI',system-ui,sans-serif", background:"var(--bg-root)", color:"var(--text)", minHeight:"100vh", fontSize:15 };
  ...
  if(authLoading) return (
    <div style={{ ...ROOT, display:"flex", alignItems:"center", justifyContent:"center", minHeight:"100vh" }}>
      <div style={{ textAlign:"center" }}>
        ...
        <div style={{ color:"var(--text-dim)", fontSize:"0.82rem", letterSpacing:2, textTransform:"uppercase" }}>A carregar...</div>
      </div>
    </div>
  );
