        ...
        <div>
          ...
          {loadingMsgs ? (
            ...
            <div style={{ textAlign:"center", padding:"48px 0", color:"#888" }}>
              ...
              <p style={{ marginBottom:20 }}>Ainda não enviaste nenhuma mensagem de contacto.</p>
              <Btn onClick={()=>goPage("contacto")}>Contactar Suporte</Btn>
            </div>
            ...
            <div key={m.id} style={{ background:"#1a1a1a", border:"1px solid #2a2a2a", borderRadius:4, padding:20, marginBottom:16 }}>
              ...
              {m.respondida && m.resposta && (
                <div style={{ background:"rgba(200,169,110,0.06)", border:"1px solid rgba(200,169,110,0.2)", borderRadius:4, padding:16 }}>
